...
pub fn build(b: *std.Build) void {
    ...
    // mupdf-zig: typed Zig wrapper over MuPDF's C API. The dep's `mupdf` module
    // carries its own C bridge compile + MuPDF link state, so importing it is enough.
